...
//otp sensor
extern int ov13850r2a_update_eeprom();
extern bool OV13850AC_OTP_combination_read(void);
   ...
   //write_cmos_sensor(0x0103, 0x01);//,
	  write_cmos_sensor(0x351b, 0x00);
		...
		*/
		...
		write_cmos_sensor(0x3600, 0x00); //blooming test neil  0xc0
		write_cmos_sensor(0x3601, 0xfc);
		write_cmos_sensor(0x3602, 0x02);
		write_cmos_sensor(0x3603, 0x78);
		write_cmos_sensor(0x3604, 0xb1);
		write_cmos_sensor(0x3605, 0x9f); //blooming test neil  0xb5
		write_cmos_sensor(0x3606, 0x73);
		write_cmos_sensor(0x3607, 0x27); //looming test neil  0x07
		write_cmos_sensor(0x3609, 0x00); //blooming test neil  0x40
